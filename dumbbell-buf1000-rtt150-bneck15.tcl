...
set opt(nsrc) 2;                # number of sources in experiment 8
...
set opt(bneck) 1000Mb;             # bottleneck bandwidth (for some topos) 15Mb
set opt(maxq) 10000;             # max queue length at bottleneck 1000
...
set opt(offavg) 0.2;              # mean on and off time 0.2
set opt(avgbytes) 100000;          # 16 KBytes flows on avg (too low?) 100000
